    ...
    switch (true) {
      case ['santo amaro', 'boa vista', 'coelhos', 'soledade', 'recife'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a href="tel:+5581992516813" class="modal-link">99251-6813</a> / <a href="tel:+5532321547" class="modal-link">3232-1547</a> / <a href="tel:+5532321548" class="modal-link">3232-1548</a><br/>
          E-mail: <a href="mailto:crasboavista01@gmail.com" class="modal-link">crasboavista01@gmail.com</a><br/>
      ...
      case ['ilha joana bezerra', 'cabanga', 'são josé', 'ilha do leite', 'paissandu'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a href="tel:+5581992646612" class="modal-link">99264-6612</a> / <a href="tel:+5533558665" class="modal-link">3355-8665</a><br/>
          E-mail: <a href="mailto:crasjoanabezerra@gmail.com" class="modal-link">crasjoanabezerra@gmail.com</a><br/>
      ...
      case ['campina do barreto', 'arruda', 'campo grande', 'encruzilhada', 'hipodromo', 'peixinhos', 'ponto de parada', 'rosarinho', 'torreão', 'cajueiro', 'fundão', 'porto da madeira'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588993233168">99323-3168</a> / <a class="modal-link" href="tel:+5532327897">3232-7897</a> / <a class="modal-link" href="tel:+5532327846">3232-7846</a> / <a class="modal-link" href="tel:+5532327902">3232-7902</a><br/>
          E-mail: <a class="modal-link" href="mailto:crascampina@gmail.com">crascampina@gmail.com</a><br/>
      ...
      case ['alto santa terezinha', 'água fria', 'bomba do hemetério', 'beberibe', 'dois unidos', 'linha do tiro'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5581991592890">99159-2890</a> / <a class="modal-link" href="tel:+5534497707">3449-7707</a><br/>
          E-mail: <a class="modal-link" href="mailto:crasaltosantaterezinha@gmail.com">crasaltosantaterezinha@gmail.com</a><br/>
      ...
      case ['alto do mandu', 'morro da conceição', 'casa amarela', 'alto josé bonifácio', 'alto josé do pinho', 'mangabeira', 'vasco da gama', 'derby', 'nova descoberta'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994163384">99416-3384</a> / <a class="modal-link" href="tel:+5533553341">3355-3341</a> / <a class="modal-link" href="tel:+5530413121">3441-3121</a><br/>
          E-mail: <a class="modal-link" href="mailto:crasrpa3@gmail.com">crasrpa3@gmail.com</a><br/>
        `;
        break;
      case ['dois irmãos', 'sitio dos pintos', 'apipucos', 'casa forte', 'graças', 'jaqueira', 'monteiro', 'parnamirim', 'poço', 'santana', 'tamarineira', 'macaxeira', 'brejo da guabiraba', 'córrego do jenipapo', 'guabiraba', 'passarinho', 'pauferro', 'espinheiro', 'aflitos'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886544">99488-6544</a> / <a class="modal-link" href="tel:+5532324110">3232-4110</a><br/>
          E-mail: <a class="modal-link" href="mailto:crasdoisirmaos@hotmail.com">crasdoisirmaos@hotmail.com</a><br/>
      ...
      case ['iputinga', 'cordeiro', 'várzea'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886735">99488-6735</a> / <a class="modal-link" href="tel:+5533556258">3355-6258</a><br/>
          E-mail: <a class="modal-link" href="mailto:crascordeiro@gmail.com">crascordeiro@gmail.com</a><br/>
      ...
      case ['torrões', 'engenho do meio', 'zumbi', 'cidade universitária'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886018">99488-6018</a> / <a class="modal-link" href="tel:+5533554803">3355-4803</a> / <a class="modal-link" href="tel:+5532327676">3232-7676</a><br/>
          E-mail: <a class="modal-link" href="mailto:crastorroes@gmail.com">crastorroes@gmail.com</a><br/>
      ...
      case ['madalena', 'torre', 'ilha do retiro', 'caxangá', 'prado', 'várzea'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588992548129">99254-8129</a> / <a class="modal-link" href="tel:+5533553181">3355-3181</a><br/>
          E-mail: <a class="modal-link" href="mailto:crasrosildamendessouza@gmail.com">crasrosildamendessouza@gmail.com</a><br/>
      ...
      case ['totó', 'sancho', 'jardim são paulo', 'coqueiral', 'areias', 'caçote', 'barro', 'curado', 'estância', 'tejipió'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886351">99488-6351</a> / <a class="modal-link" href="tel:+5532577187">3257-7187</a> / <a class="modal-link" href="tel:+5532494464">3249-4464</a><br/>
          E-mail: <a class="modal-link" href="mailto:cras05pcr@gmail.com">cras05pcr@gmail.com</a><br/>
      ...
      case ['bongi', 'mustardinha', 'san martin', 'afogados', 'mangueira', 'jiquiá'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588993233351">99323-3351</a> / <a class="modal-link" href="tel:+5532259446">3225-9446</a><br/>
          E-mail: <a class="modal-link" href="mailto:crasbongi@gmail.com">crasbongi@gmail.com</a><br/>
      ...
      case ['ibura de baixo', 'jordão alto', 'jordão baixo', 'vila dos milagres'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886442">99488-6442</a> / <a class="modal-link" href="tel:+5533553226">3355-3226</a><br/>
          E-mail: <a class="modal-link" href="mailto:cras6ibura@gmail.com">cras6ibura@gmail.com</a><br/>
        `;
        break;
      case ['pina', 'brasília teimosa', 'ipsep', 'imbiribeira', 'boa viagem'].includes(bairro) && localidade === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886446">99488-6446</a> / <a class="modal-link" href="tel:+5533279851">3327-9851</a> / <a class="modal-link" href="tel:+5533053380">3305-3380</a><br/>
          E-mail: <a class="modal-link" href="mailto:craspina06@outlook.com">craspina06@outlook.com</a><br/>
      ...
      case ['ibura de cima', 'cohab', 'lagoa encantada', 'novembro', 'três carneiros', 'monte verde'].includes(bairro.toLowerCase()) && localidade.toLowerCase() === 'recife':
        this.crasInfo = `
          ...
          Fone: <a class="modal-link" href="tel:+5588994886493">99488-6493</a> / <a class="modal-link" href="tel:+5534757462">3475-7462</a><br/>
          E-mail: <a class="modal-link" href="mailto:crasiburadecima@gmail.com">crasiburadecima@gmail.com</a><br/>
